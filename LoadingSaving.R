...
save.image("~/Dropbox/EmilyComputerBackup/Documents/Niwot_King/Figures&Stats/kingdata/MovingUphill3_Workspace_Analysis2.Rdata")  # 1 has minimal (no) models just data cleaned but the labels file has an error (otu/oldotu)
